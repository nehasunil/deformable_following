...
class Gripper_Controller_V2(Thread):
    ...
    def follow(self):
        ...
        self.gripper_helper.set_dc_pos(self.follow_dc)
...
class GripperHelper(object):
        ...
        def init(self):
            ...
            self.dc_motors.init_single_motor(4, motor_cpr, 1.0, 0.0, 0.3, ctrl_mode=0) # position control
            # dc_motors.init_single_motor(5, motor_cpr, 15.0, 0.2, 100.0, ctrl_mode=1)
            self.dc_motors.init_single_motor(5, motor_cpr, 1.0, 0.0, 0.3, ctrl_mode=0)
