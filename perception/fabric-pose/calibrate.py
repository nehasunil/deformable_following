...
def save_csv():
    filename = f"config/config_{sensor_id}.csv"
...
# stream=urllib.request.urlopen('http://rpihome1.local:8080/?action=stream')
...
# stream=urllib.request.urlopen('http://rpishawn1.local:8080/?action=stream')
